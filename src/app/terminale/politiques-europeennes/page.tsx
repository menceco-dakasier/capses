...
function StepRessources() {
  return <div>
    ...
    {/* Vidéo YouTube */}
    <div style={{marginBottom:"1.5rem"}}>
      <div style={{fontSize:13,fontWeight:700,color:"#7EB8FF",fontFamily:"Space Grotesk, sans-serif",marginBottom:10}}>🎬 Cours vidéo — Les politiques économiques européennes</div>
      <div style={{position:"relative",paddingBottom:"56.25%",height:0,borderRadius:12,overflow:"hidden",border:"1px solid rgba(126,184,255,0.2)"}}>
        <iframe
          src="https://www.youtube.com/embed/XCoxv-b0uO0"
          title="Cours vidéo — Les politiques économiques européennes"
